...
def _print_banner() -> None:
    """Print the warez scene ASCII art banner — classic ANSI art style."""
    D = "dim"
    D2 = "grey50"
    B = "steel_blue1"     # blue tones for smoke
    B2 = "deep_sky_blue1" # brighter blue
    C = "bright_cyan"
    M = "bright_magenta"
    W = "white"
    Y = "bright_yellow"
    ...
    # Escape { and } for Rich markup by doubling them — except our actual markup tags
    banner = f"""\
[{D}]                      .        ·    .          .    ·        .                    [/{D}]
[{D2}]            .    ,d$$$bp.          ,d$$b,           .d$$$b,     ·         [/{D2}]
[{B}]       ·      ,d$$$$$$$$$$b.    ,d$$$$$$$$b,     .d$$$$$$$$$$b.           [/{B}]
...
[{D}]                          `""$$$$$$$$$$$$$""'                       [/{D}]
[{D}]   ·─────────────────────────────────────────────────────────────·  [/{D}]
[{D}]   │[/{D}] [{Y}] SharePoint Bulk Downloader[/{Y}] [{D}]v0.1 │ Ctrl+C cancel │ Re-run resume │[/{D}]
[{D}]   ·─────────────────────────────────────────────────────────────·  [/{D}]"""
