...
def _print_banner() -> None:
    """Print the warez scene ASCII art banner — Blocktronics/FIRE inspired."""
    # ANSI scene palette
    R = "red"            # deep red (flame base)
    BR = "bright_red"    # hot red
    Y = "bright_yellow"  # flame tips / acid
    M = "bright_magenta" # neon pink
    C = "bright_cyan"    # electric cyan
    G = "bright_green"   # matrix green
    W = "white"
    D = "dim"
...
[{D}]  ║[/{D}] [{D}]      ░░      ░░░   ░      ░░░   ░      ░      ░░░       [/{D}][{D}]║[/{D}]
[{D}]  ║                                                                ║[/{D}]
[{D}]  ║[/{D}]     [{Y}]▓▓[/{Y}] [{W}]SharePoint Bulk Downloader[/{W}]  [{D}]v0.1.0[/{D}]               [{D}]║[/{D}]
[{D}]  ║[/{D}]     [{G}]▒▒[/{G}] [{D}]Ctrl+C to cancel · Re-run to resume[/{D}]            [{D}]║[/{D}]
[{D}]  ║                                                                ║[/{D}]
[{D}]  ·════════════════════════════════════════════════════════════════·[/{D}]"""
